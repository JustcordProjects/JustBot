...
export class EconomyExecutor {
    ...
    getRoleById(id: string) {
        return cfg.features.economy.roles.find((r) => r.id == id);
    }
    getItemById(id: string) {
        return cfg.features.economy.items.find((i) => i.id == id);
    }
    getOfferById(id: string) {
        return cfg.features.economy.offers.find((o) => o.id == id);
    }
    ...
    getRoleByName(name: string) {
        return this.getByName(name, cfg.features.economy.roles);
    }
    getItemByName(name: string) {
        return this.getByName(name, cfg.features.economy.items);
    }
    getOfferByName(name: string) {
